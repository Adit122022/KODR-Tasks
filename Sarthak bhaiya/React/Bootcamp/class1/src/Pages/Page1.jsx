...
and conquering
hearts 
<div className="md:w-20 w-16 inline-block">
<svg className='animate text-xl  md:mx-8' xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 52 52" fill="none" preserveAspectRatio="xMidYMid meet" aria-hidden="true" role="img">
...
<div className='md:w-1/3 content-end leading-9 md:pl-40 mt-10'>

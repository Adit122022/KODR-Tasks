  ...
  return (
   <>
    <div className='w-full px-20 py-8 flex justify-between '>
        <h1 className='text-[110px] leading-[0.9] font-normal  font-serif w-3/5'>
       Turning heads
and conquering
hearts 
<div className="w-20 inline-block">
<svg className='animate text-xl  mx-8' xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 52 52" fill="none" preserveAspectRatio="xMidYMid meet" aria-hidden="true" role="img">
...
<div className='w-1/3 content-end leading-9 pl-40 '>

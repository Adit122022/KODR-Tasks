...
const Card = ({character}) => {
  return (
    <div className='text-white w-80 flex-grow h-3/4 flex group hover:justify-center hover:items-center  shadow-md  rounded-3xl flex-shrink-0  relative overflow-hidden'>
